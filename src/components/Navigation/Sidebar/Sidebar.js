...
const sidebar = () => {
    ...
    return (
        <Aux>
            <div className="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-secondary overflow-y-auto lg:translate-x-0 lg:static lg:inset-0 sm:hidden ">
